...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Iglar\IGlar\IGlar\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Iglar\\IGlar\\IGlar\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'welcome','profile','register',
'login','add.post','store.post','storage.local',);
        registerArgumentsSet('views', 
'Auth.login','Auth.register','add-post','layout.layout','layout.layout-addPost',
'layout.layout-login','layout.layout-register','layout.profile-layout','partials.addPost-form','partials.bottom-bar',
'partials.bottom-part','partials.bottom-part-grey','partials.bottom-part-photos','partials.head','partials.headLog',
'partials.headReg','partials.login-box','partials.post','partials.profilehead','partials.register-box',
'partials.sidebar','partials.stories','partials.upper-part','profile','welcome',
